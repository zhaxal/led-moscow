...
const Tutorial = () => {
    return (
        <Container maxWidth={"xl"} sx={{ mt: "80px" }}>
            ...
            >
                <Stack sx={{ width: "46%", height: "70%", ml: "150px", justifyContent: "center", alignItems: "center" }} spacing={2}>
                    <Typography
                        variant={"about"}
                    ...
                    />
                    <Stack sx={{ width: "100%", height: "42px", justifyContent: "center", alignItems: "center", border: "1px dashed #FFFFFF" }}>
                        <Typography sx={{
